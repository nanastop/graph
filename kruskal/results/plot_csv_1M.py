...
plots = [
        PlotData(
            string_product(['rand1Mx1M','rmat1Mx1M','ssca1Mx3M'],
                           ['cpt','pct'],'+'),
            '1Mx1M', 'speedups_1Mx1M.pdf'),

        PlotData(
            string_product(['rand1Mx5M','rmat1Mx5M','ssca1Mx6M'],
                           ['cpt','pct'],'+'),
            '1Mx5M', 'speedups_1Mx5M.pdf'),

        PlotData(
            string_product(['rand1Mx10M','rmat1Mx10M','ssca1Mx11M'],
                           ['cpt','pct'],'+'),
            '1Mx10M', 'speedups_1Mx10M.pdf'),

        PlotData(
            string_product(['rand1Mx20M','rmat1Mx20M','ssca1Mx29M'],
                           ['cpt','pct'],'+'),
            '1Mx20M', 'speedups_1Mx20M.pdf'),

        PlotData(
            string_product(['rand1Mx50M','rmat1Mx50M','ssca1Mx59M'],
                           ['cpt','pct'],'+'),
            '1Mx50M', 'speedups_1Mx50M.pdf'),

        PlotData(
            string_product(['rand1Mx100M','rmat1Mx100M','ssca1Mx119M'],
                           ['cpt','pct'],'+'),
            '1Mx100M', 'speedups_1Mx100M.pdf'),
